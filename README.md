...
This project aims to fill this research gap by applying data mining and statistical techniques to a combined dataset that includes: 1. Information on natural disasters between 2008 and 2023 2. Economic and human development metrics for this time period. We aim to illustrate we can view the affects of impactful natural disasters on economic indicators per country (with Puerto Rico and Philippines as our main illustrations). These methods can be applied to guide economic policy and inform better disaster response strategies and recovery plans.
